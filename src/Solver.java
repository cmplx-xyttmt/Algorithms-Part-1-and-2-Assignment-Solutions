    ...
    public Solver(Board initial){
        ...
        while (!nodes.min().getBoard().isGoal() && !nodes1.min().getBoard().isGoal()){
            ...
            for (Board board: curr.getBoard().neighbors()){
                ...
                else if (curr.getPrevious() == null)nodes.insert(new Node(board, curr.getMoves() + 1, curr));
            }
            ...
            for (Board board: curr.getBoard().neighbors()){
                ...
                else if (curr.getPrevious() == null)nodes1.insert(new Node(board, curr.getMoves() + 1, curr));
            }
        }
